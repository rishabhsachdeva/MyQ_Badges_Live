...
//            call.execute();
        ...
        else  if (mParam2 != null && !mParam2.isEmpty())
        {
            ...
            String qapi = "http://myish.com:10010/api/questions_levels?";
            if (mParam2.equals("E")) {
...
//                call.execute();
        ...
        else  if (mParam3 != null && !mParam3.isEmpty())
        {
            ...
            String qapi = "http://myish.com:10010/api/questions_category?";
    ...
    public void getQuestions(String QUESTIONS_REQUEST_URL){
        ...
        client.get(getActivity(), QUESTIONS_REQUEST_URL , new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray responseArray) {
                ...
                Collections.reverse(al_id);
                Collections.reverse(al_correctAns);
